...
const createContracts = (web3, opts: Opts) => ({
  farm: createContract(web3, farmAbi, opts.farmAddress),
  rewards: createContract(web3, rewardsAbi, opts.rewardsAddress),
  staking: createContract(web3, stakingAbi, opts.stakingAddress),
})
